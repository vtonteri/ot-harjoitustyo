...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_jonka_jälkeen_kortin_saldo_on_nolla(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_kortilla_voi_ostaa_maukkaan_lounaan_jonka_jälkeen_kortin_saldo_on_nolla(self):
